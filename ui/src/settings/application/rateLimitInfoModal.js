...
function rateLimitInfoModal() {
    return t.div(
        ...
        t.header({ className: "modal-header" }, t.h5(null, "قالب برچسب محدودیت نرخ")),
        t.div(
            { className: "modal-content" },
            t.p(null, "قوانین محدودیت نرخ به ترتیب زیر حل می‌شوند (روی اولین مورد منطبق توقف می‌کنند):"),
            t.ol(
                null,
                t.li(null, "برچسب دقیق (مثلاً ", t.code(null, "users:create")),
                t.li(null, "برچسب کاراکترهای جایگزین (مثلا ", t.code(null, "*:create")),
                t.li(null, "روش + مسیر دقیق (مثلاً ", t.code(null, "POST /a/b")),
                t.li(null, "روش + پیشوند مسیر (مثلاً ", t.code(null, "POST /a/b", t.strong(null, "/"))),
                t.li(null, "مسیر دقیق (مثلاً ", t.code(null, "/a/b")),
                t.li(null, "مسیر پیشوندی (مثلاً ", t.code(null, "/a/b", t.strong(null, "/"))),
            ),
            t.p(
                null,
                `در صورت وجود چندین قانون با برچسب یکسان اما مخاطب هدف متفاوت (مثلاً "guest" در مقابل "auth")، فقط قانون مخاطب منطبق در نظر گرفته می‌شود.`,
            ),
            t.hr(),
